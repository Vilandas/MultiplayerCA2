...
: State(stack, context)
{
	...
	play_button->setPosition(850, 500);
	...
	host_play_button->setPosition(850, 575);
	...
	join_play_button->setPosition(850, 650);
	...
	settings_button->setPosition(850, 725);
	...
	exit_button->setPosition(850, 800);
